...
def root_post_1_sentiments(request, participant2_user, discussion, test_session, root_post_1):
    """
    From participant1_user
    """
    from assembl.models.action import (
    LikeSentimentOfPost, MoreInfoSentimentOfPost)

    like = LikeSentimentOfPost(
        post=root_post_1, discussion=discussion, actor_id=participant2_user.id)
