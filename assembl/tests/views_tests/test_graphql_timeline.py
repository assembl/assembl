...
def test_mutation_create_discussion_phase_empty_identifier(graphql_request, discussion_with_2_phase_interface_v2, graphql_registry):
    res = schema.execute(
    ...
    assert phase['id']
    assert phase['identifier'] == Node.from_global_id(phase['id'])[1]
