...
from ..lib.history_meta import Versioned, versioned_session, declare_history_mappers, _versioned_mappers
...
class TestVersioning(TestCase, AssertsCompiledSQL):
    ...
    def tearDown(self):
        self.session.close()
        # This does not seem necessary and kills other tests
        #clear_mappers()
        del _versioned_mappers[:]
