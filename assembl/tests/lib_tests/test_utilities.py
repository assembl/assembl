...
#from assembl.models.discussion import read_post_ids


# def test_get_localizer(test_dummy_web_request):
# 	request = test_dummy_web_request
# 	localizer = request.localizer
# 	assert get_localizer(request) == localizer
# 	assert get_localizer(None) == localizer 
...
class TestStripCountry(object):
	def test_strip_country_case1(self):
		#There is only one case for this function since it assumes a posix locale
		locale = "fr_FR"
