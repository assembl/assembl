...
def test_add_semantic_analysis_to_all_discussions(discussion):
    ...
    add_semantic_analysis_to_all_discussions(discussion.db)
...
def test_add_semantic_analysis_to_all_discussions_already_added(discussion_with_default_data):
    from assembl.lib.migration import add_semantic_analysis_to_all_discussions
    from assembl import models as m
    from assembl.models.section import SectionTypesEnum

    add_semantic_analysis_to_all_discussions(discussion_with_default_data.db)
