...
class AttachmentPurpose(enum.Enum):
    ...
    LOGO = 'LOGO'
    # legal contents
    LEGAL_NOTICE_ATTACHMENT = 'LEGAL_NOTICE_ATTACHMENT'
    TERMS_AND_CONDITIONS_ATTACHMENT = 'TERMS_AND_CONDITIONS_ATTACHMENT'
    COOKIES_POLICY_ATTACHMENT = 'COOKIES_POLICY_ATTACHMENT'
    PRIVACY_POLICY_ATTACHMENT = 'PRIVACY_POLICY_ATTACHMENT'
    USER_GUIDELINES_ATTACHMENT = 'USER_GUIDELINES_ATTACHMENT'
    # idea announcement
    ANNOUNCEMENT_BODY_ATTACHMENT = 'ANNOUNCEMENT_BODY_ATTACHMENT'
