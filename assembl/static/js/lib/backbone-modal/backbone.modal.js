(function () {
    ...
    Backbone.Modal = (function (_super) {
        ...
        Modal.prototype.render = function (options) {
            ...
            this.$el.addClass("popin-wrapper");
            this.modalEl = Backbone.$('<div />').addClass("popin");
            if (this.template) {
        ...
        Modal.prototype.clickOutside = function (e) {
            if (Backbone.$(e.target).hasClass("popin-wrapper") && this.active) {
        ...
        Modal.prototype.close = function () {
            ...
            this.modalEl.addClass("popin-close");
            this.$el.fadeOut({
                duration: 200
            });
