...
define(['common/context', 'utils/i18n', 'utils/permissions', 'common/collectionManager', 'backbone.marionette', 'jquery', 'underscore', 'bluebird'],
    function (Ctx, i18n, Permissions, CollectionManager, Marionette, $, _, Promise) {
