...
class ResourcesCenter extends React.Component {
  render() {
    ...
    const resourceVideoUrl = 'https://i.ytimg.com/vi_webp/kWmX3pd1f10/sddefault.webp';
    const bodyText =
    ...
    return (
      <div className="resources-center">
        ...
        <section>
          <ResourceBlock title={resourceTitle} imgUrl={resourceImgUrl} bodyText={bodyText} index={2} />
          <ResourceBlock title={resourceTitle} videoUrl={resourceVideoUrl} bodyText={bodyText} index={3} />
