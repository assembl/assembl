  ...
  render() {
    return (
      <div className="margin-xxl">
        <h2 className="dark-title-2 underline" id="icons" style={{ borderBottom: '1px solid #ccc' }}>
          ICONS
        </h2>
        <section>
        ...
        <section>
          ...
          <pre>&lt;span className="assembl-icon-add"&gt;&lt;/span&gt;</pre>
          <pre>&lt;span className="assembl-icon-add color"&gt;&lt;/span&gt;</pre>
          <pre>&lt;span className="assembl-icon-add grey"&gt;&lt;/span&gt;</pre>
          <pre>&lt;span className="assembl-icon-add black"&gt;&lt;/span&gt;</pre>
          <pre>&lt;span className="assembl-icon-add white"&gt;&lt;/span&gt;</pre>
          <pre>
