...
class ToArgument extends React.Component {
  ...
  render() {
    ...
    return (
      <svg width="20px" height="20px" viewBox="0 0 20 20">
        <g id="icone-argumenter" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
          <g id="Argumenter">
            ...
            <g
              id="right-arrow-(4)-copy"
              transform="translate(9.000000, 10.000000) scale(-1, 1) translate(-9.000000, -10.000000) translate(4.000000, 7.000000)" // eslint-disable-line
              fill={color}
              fillRule="nonzero"
              stroke={color}
              strokeWidth="0.5"
