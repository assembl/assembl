...
const MoreSpecific = ({ backgroundColor, color }: Props) => (
  <svg width="20px" height="20px" viewBox="0 0 20 20">
    <g id="icone-Rendre-opérationnel" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
      <g id="Rendre-opérationnel">
