        ...
        <div className="max-container">
          <Row>
            {ideaOnColumns.map((column, index) => {
              return (
                <Col xs={12} md={12 / ideaOnColumns.length} style={{ backgroundColor: column.color }} key={index}>
                    ...
                    <Row>
                      ...
                      >
                        <div className="start-discussion-container">
                          <div
                            className={
                              mockMessageColumns.length > 0 ? 'start-discussion-icon' : 'start-discussion-icon onecolumn'
                            }
                          >
                            <span className="assembl-icon-discussion color" />
                          </div>
                          <div className={mockMessageColumns.length > 0 ? 'start-discussion' : 'start-discussion onecolumn'}>
