...
export const createGaugeVoteModule = (id: string): actionTypes.CreateTokenVoteModule => ({
  id: id,
  type: actionTypes.CREATE_GAUGE_VOTE_MODULE
});

export const deleteGaugeVoteModule = (id: string): actionTypes.DeleteTokenVoteModule => ({
  id: id,
