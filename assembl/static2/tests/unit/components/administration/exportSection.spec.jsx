...
describe('DumbExportSection component', () => {
  it('should render an DumbExportSection component without languages options', () => {
    const props = {
      voteSessionId: '123',
      debateId: '7',
      exportLink: 'foo.com'
    };
    const component = renderer.create(<DumbExportSection {...props} />);
    const tree = component.toJSON();
    expect(tree).toMatchSnapshot();
  });

  it('should render an DumbExportSection component with languages options', () => {
  ...
  it('should update exportLink in state when user clicks on on export link option', () => {
    ...
    const wrapper = mount(<DumbExportSection {...props} />);
