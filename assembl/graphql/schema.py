...
from assembl.graphql.post import (AddPostAttachment, CreatePost, DeletePost,
                                  ...
                                  AddPostsExtract, UpdateSocialShareCountOnPost)
...
class Mutations(graphene.ObjectType):
    ...
    update_social_share_count_on_post = UpdateSocialShareCountOnPost.Field(description=docs.UpdateSocialShareCountOnPost.__doc__)
