...
from assembl.graphql.preferences import UpdateHarvestingLocale
...
class Mutations(graphene.ObjectType):
    ...
    update_harvesting_locale = UpdateHarvestingLocale.Field(description=docs.UpdateHarvestingLocale.__doc__)
