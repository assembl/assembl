...
from assembl.graphql.user import UpdateUser, DeleteUserInformation, UpdateAcceptedCookies, DeleteAcceptedCookies
...
class Mutations(graphene.ObjectType):
    ...
    delete_accepted_cookies = DeleteAcceptedCookies.Field()
