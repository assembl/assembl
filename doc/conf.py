# -*- coding: utf-8 -*-
#
# Assembl documentation build configuration file, created by
...
project = u'Assembl'
copyright = u'2014, Imagination For People'
...
latex_documents = [
  ('index', 'Assembl.tex', u'Assembl Documentation',
   u'Imagination For People', 'manual'),
]
